...
if (isset($_GET['search_query']) && !empty($_GET['search_query'])) {
    ...
    $filtered_prescriptions = array_filter($prescriptions, function ($prescription) use ($search_query) {
        // Customize this condition based on your data structure
        return stripos($prescription['patient_name'], $search_query) !== false;
    });
...
if (isset($_GET['sort_select'])) {
    ...
    // Sort the $prescriptions array based on fabricant name
    if ($sort_option === 'az') {
        ...
        usort($prescriptions, function ($a, $b) {
            return strcmp($b['patient_name'], $a['patient_name']);
        });
    }
}
?>
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li  class="active" ><a  href="backanis.php"><em class="fa fa-clone">&nbsp;</em> Prescriptions</a></li>
...
<body>
	...
	<form id="sortForm" method="GET" style="text-align: center;">
            <label for="sort_select">Sort By Prescription Name:</label>
