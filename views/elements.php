...
<head>
	...
	<title>Prescription BackOffice</title>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<div class="profile-sidebar">
			<div class="profile-userpic">
				<img src="C:/xampp/htdocs/prescriptions/views/slimen" class="img-responsive" alt="">
			</div>
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="elements.php"><em class="fa fa-toggle-off">&nbsp;</em>prescription</a></li>
